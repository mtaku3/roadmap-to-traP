...
var jsonFieldsNameOfMessage = [9]string{
	0: "id",
	1: "userId",
	2: "channelId",
	3: "content",
...
// Encode encodes UserGroupMember as json.
func (o OptUserGroupMember) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
func (o *OptUserGroupMember) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptUserGroupMember to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptUserGroupMember) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptUserGroupMember) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfPostMessageRequest = [2]string{
	0: "content",
	1: "embed",
}
